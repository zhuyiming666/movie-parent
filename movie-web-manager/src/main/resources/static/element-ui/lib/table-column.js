...
// EXTERNAL MODULE: external "element-ui/lib/utils/common"
...
// EXTERNAL MODULE: ./packages/table/src/common.js
...
/* harmony default export */ var table_column = ({
  ...
  methods: {
    ...
    registerNormalWatchers: function registerNormalWatchers() {
      ...
      var props = ['label', 'property', 'filters', 'filterMultiple', 'sortable', 'index.html', 'formatter', 'className', 'labelClassName', 'showOverflowTooltip'];
      // 一些属性具有别名
      var aliases = {
        prop: 'property',
        realAlign: 'align',
...
module.exports = require("element-ui/lib/utils/common");
